...
class InputMaskDirective {
    ...
    createInputMaskPlugin() {
        ...
        const { parser } = inputMaskOptions, options = __rest(inputMaskOptions, ["parser"]);
...
InputMaskModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.0.0", ngImport: i0, type: InputMaskModule, declarations: [InputMaskDirective], exports: [InputMaskDirective] });
InputMaskModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.0.0", ngImport: i0, type: InputMaskModule, providers: [
        {
