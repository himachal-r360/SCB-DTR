              ...
              break;
                ...
                case 'TEXT_LOGO':
                 ...
                 html ='<div class="toast_push " id="toast_'+index+'"  >'+
                                                 ...
                                                 '<span class="toast-close" aria-hidden="true" >&times;</span>'+
                                               '</button></div> <div class="toast-wrap col-md-12 p-0" (click)="trackEventToastClick()" onclick="Window.myComponent.trackEventToastClick(\''+val['redirect_url']+'\','+val['id']+')"><a href="'+val['redirect_url']+'">  <div class="row"><div class="col-2 "><div class="push-wrapper-new"><img src="'+image_url+'" class="" alt="..." style="max-width: fit-content;"  ><img class="notify-pos-abs" src="'+subimage_url+'" alt=""/></div></div><div class="text-truncate-new col-10">'+
